...
export const MOCK_PEOPLE: (Entity & { person: EntityPerson })[] = [
  {
    ...
    person: {
      ...
      address: "27 Boulevard Albert 1er, 98000 Monaco",
      phone: "***4512",
      email: "jp.moretti@example.mc",
      profession: "Conseiller National / Investisseur",
      is_pep: true,
  ...
  },
  {
    ...
    person: {
      ...
      nationality: "IT",
      country_of_residence: "MC",
      address: "3 Rue Grimaldi, 98000 Monaco",
      phone: "***7834",
      email: "e.vasquez@example.mc",
  ...
  },
  {
    ...
    person: {
      ...
      nationality: "RU",
      country_of_residence: "MC",
      address: "15 Avenue de la Costa, 98000 Monaco",
      phone: "***9021",
      email: null,
...
export const MOCK_COMPANIES: (Entity & { company: EntityCompany })[] = [
  {
    ...
    company: {
      ...
      address: "7 Avenue de Grande Bretagne, 98000 Monaco",
      phone: "***8800",
      email: "contact@monacotrading.mc",
      website: "www.monacotrading.mc",
      capital: "500 000 €",
    },
  },
  {
    ...
    company: {
      ...
      address: "12 Boulevard des Moulins, 98000 Monaco",
      phone: null,
      email: "admin@rivierawealth.mc",
      website: null,
      capital: "150 000 €",
    },
  },
...
export const MOCK_RISK_FACTORS: Record<string, RiskFactor[]> = {
  e1: [
    { category: "Client", factor: "PEP", impact: 25, details: "Conseiller National — élu du Conseil National de Monaco" },
    { category: "Structure", factor: "UBO multi-sociétés", impact: 20, details: "UBO de Monaco Trading SAM (65%) + Riviera Wealth SCI (100%)" },
    { category: "Activité", factor: "Trading commodities", impact: 15, details: "Secteur à risque LCB-FT via Monaco Trading SAM" },
    { category: "Volume", factor: "Transactions élevées", impact: 12, details: "Flux >500K€/mois entre les deux sociétés" },
  ],
  e2: [
    { category: "Client", factor: "Profil standard", impact: 5, details: "Résidente italienne à Monaco, aucun signal" },
    { category: "Géographique", factor: "UE", impact: 5, details: "Nationalité italienne — cadre réglementaire équivalent" },
    { category: "Activité", factor: "Direction société", impact: 10, details: "Directrice de Monaco Trading SAM" },
  ],
  e3: [
    { category: "Client", factor: "UBO PEP", impact: 20, details: "UBO Jean-Pierre Moretti est PEP (Conseiller National)" },
    { category: "Structure", factor: "Actionnaire sanctions", impact: 18, details: "Dmitri Volkov (20%) — sanctions match EU en cours de revue" },
    { category: "Activité", factor: "Trading commodities", impact: 12, details: "Secteur identifié à risque par l'AMSF" },
    { category: "Structure", factor: "Multi-actionnariat", impact: 8, details: "3 actionnaires de nationalités différentes (MC, IT, RU)" },
  ],
  e5: [
    { category: "Client", factor: "Sanctions match", impact: 30, details: "Match EU Consolidated Sanctions — confiance 82%" },
    { category: "Géographique", factor: "Pays à risque GAFI", impact: 25, details: "Nationalité russe — juridiction sous sanctions UE" },
    { category: "Média", factor: "Adverse media", impact: 20, details: "Article Reuters nov. 2025 — enquête sur nationaux russes à Monaco" },
    { category: "Structure", factor: "Actionnaire société MC", impact: 10, details: "20% de Monaco Trading SAM — lien avec PEP monégasque" },
  ],
};
